...
3) Запустить с повышеными привилегиями консоль PowerShell x86(иначе будут сыпать ошибки) и запустить комманды
...
если у вас сыпят ошибки, значит вы запустили не PowerShell x86, при выполнении конманд!!!